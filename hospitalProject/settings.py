...
# Optional Graphene app: include if installed to avoid import errors when
# running outside the project's virtualenv.
try:
...
# Redirect after login to the dashboard redirect view
